...
blocks = [
# blocks = [  "#162eb239-00fd-4f18-a0ba-58e02f83a1c0", ##-- 0.7282 fb-1 
            "#88bfc4ee-4270-48d6-8127-a86a15ba3094", ##-- Blocks 1 to 5 inclusive: 2.621843211 fb-1 
...
for i, block in enumerate(blocks):
    ...
    # COMMAND = "dasgoclient --query='file block=/ZeroBias/Run2018C-v1/RAW%s' >> Files_Block_%s.txt"%(block, i) ##-- to save file names in txt files 
    COMMAND = "dasgoclient --query='run block=/ZeroBias/Run2018C-v1/RAW%s' >> Runs_Block_%s.txt"%(block, i) ##-- To compute luminosities for each run 
    os.system(COMMAND)
