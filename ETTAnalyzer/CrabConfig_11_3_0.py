...
config.General.requestName = 'ETTAnalyzer_CMSSW_11_3_0_CRUZET_2021'
...
config.Data.outputPrimaryDataset = 'MinimumBias_July_2021_CRUZET'
...
config.Data.outputDatasetTag = 'ETTAnalyzer_CMSSW_11_3_0_CRUZET_2021'
config.Data.publication = False 

config.Data.userInputFiles = CMS_files 

# config.Site.whitelist = ['T2_FR_GRIF_LLR']
config.Site.whitelist = ['T2_CH_CERN'] ##-- Eventually had to change from LLR whitelist to this 
