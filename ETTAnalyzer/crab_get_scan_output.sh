...
do
   {
   mkdir -p /eos/user/t/tdesrous/scans/delay$i
   ...
   rm -rf root://eos.grif.fr//eos/grif/cms/llr/store/user/tdesrous/Scan_delay_$i/Run_366713/ETTAnalyzer_CMSSW_12_3_0_DoubleWeights_ReemulateFromGlobalTag/* 
